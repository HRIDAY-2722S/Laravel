...
@section('content')
    ...
    <div class="container-fluid"><meta name="csrf-token" content="{{ csrf_token() }}">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mt-4">
                    @if($quotationproducts->isEmpty())
                        <div class="alert alert-warning">
                        This quotation does not correspond to any product..
                        </div>
                    @else
                        @php
                                ...
                                @foreach ($quotationproducts as $quotationproduct)
                                    ...
                                    <tr class="quotations">
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <span class="quotation-name"><a href="{{ route('singleproducts', ['id' => $quotationproduct->product_id]) }}">{{ $product->name }}</a></span>
                                        </td>
                                        <td>${{ $product->price }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <form action="{{ route('deletequotationproduct', ['id' => $quotationproduct->id]) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                        ...
                        <div style="display: flex;">
                            ...
                            <div id="summary-cart" class="summary-cart" style="margin-top: 15px; margin-left: 53%;">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-btn').on('click', function(e) {
                ...
                if (confirm("Kindly verify if you wish to remove this product from the quotation.")) {
                    form.submit(); 
                }
            });
            ...
            $('#update-btn').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route('updatequotationsproductsquantity') }}', 
                    type: 'POST',
                    data: {
